...
# Aperture just past diamond window/old beamstop
class SRXDiamondAperture(Device):
    x = Cpt(EpicsMotor, 'X}Mtr') # XF:05IDD-ES:1{Det:2-Ax:X}Mtr
    y = Cpt(EpicsMotor, 'Y}Mtr') # XF:05IDD-ES:1{Det:2-Ax:Y}Mtr


diamond_aperture = SRXDiamondAperture('XF:05IDD-ES:1{Det:2-Ax:', name='diamond_aperture')

# EJM: Commented out as of 20250228. To be removed.
