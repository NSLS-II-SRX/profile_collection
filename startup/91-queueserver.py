...
def get_current_position():
	...
	topx, topz = nano_stage.topz.position, nano_stage.topz.position #top
...
def recover_and_scan(label,roi_positions, mot1_s, mot1_e, mot1_n, mot2_s, mot2_e, mot2_n, exp_t):
...
def send_to_plan_queue(label, mot1_s, mot1_e, mot1_n, mot2_s, mot2_e, mot2_n, exp_t):
