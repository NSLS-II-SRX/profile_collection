...
from ophyd import Device, EpicsMotor, EpicsSignal, EpicsSignalRO, PVPositionerPC
...
class SRXNanoKB(Device):
    ...
    v_pitch = Cpt(SRXNanoKBFine, 'XF:05IDD-ES:1{nKB:vert-Ax:PC}', name='nanoKB_v_pitch', add_prefix=()) # XF:05IDD-ES:1{nKB:vert-Ax:PC}RPOS
    ...
    h_pitch = Cpt(SRXNanoKBFine, 'XF:05IDD-ES:1{nKB:horz-Ax:PC}', name='nanoKB_h_pitch', add_prefix=()) # XF:05IDD-ES:1{nKB:horz-Ax:PC}RPOS
